...
class EditStore extends StatefulWidget {
  EditStore({Key key, this.employee, this.state, this.store}) : super(key: key);
  Employee employee;
  Store store;
...
class _EditStoreState extends State<EditStore> {
                          ...
                          TableRow(children: [
                            ...
                            TableCell(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    autofocus: true,
                                    initialValue: widget.store.remains.toString(),
                                    inputFormatters: [
                                    ...
                                    validator: (val) {
                                      return int.tryParse(val) == null
                                          ? 'Поле остатка не заполнено или заполнено неправильно'
                                          : null;
                                    },
                                  ),
                                ))
                          ...
                          TableRow(children: [
                            ...
                            TableCell(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  autofocus: true,
                                  initialValue: widget.store.manufacturer,
                                  onChanged: (value) {
                                    setState(() {
                                      manufacturer = value;
                                    });
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            autofocus: true,
                            initialValue: widget.store.desc,
                            onChanged: (value) {
                              setState(() {
                                desc = value;
                              });
  ...
  void _onFormSubmit() {
    ...
    widget.store.manufacturer = manufacturer ?? widget.store.manufacturer;
    widget.store.remains = remains ?? widget.store.remains;
    widget.store.desc = desc ?? widget.store.desc;
    widget.store.name = name ?? widget.store.name;
    widget.store.save();
    Navigator.of(context).pop();
  }
}
